 ...
 */
export function validateReleaseTitle(title: string | undefined): string {
...
export function validateArtistName(artist: string | undefined): string {
...
export function validateBarcode(barcode: string | undefined): string | undefined {
  if (!barcode) {
    return undefined;
  }
...
export function validateReleaseYear(year: number | undefined): number | undefined {
...
export function validateUrl(url: string | undefined, fieldName = 'URL'): string | undefined {
  if (!url) {
    return undefined;
  }
 ...
 */
export function validatePolicyName(name: string | undefined): string {
...
export function validateWeight(value: number | undefined, fieldName = 'Weight'): number | undefined {
  if (value === undefined || value === null) {
    return undefined;
  }
  if (typeof value !== 'number') {
...
export function validateWeightSum(
  ...
  if (Math.abs(sum - 1.0) > tolerance) {
    throw new ValidationError(
      `Media weight (${mediaWeight}) + sleeve weight (${sleeveWeight}) must equal 1.0`
    );
  }
}
...
export function validateDays(value: number | undefined, fieldName = 'Days'): number | undefined {
  if (value === undefined || value === null) {
    return undefined;
  }
 ...
 */
export function validateSearchQuery(query: string, minLength = 1, maxLength = 100): string {
...
export function validateId(id: string | undefined, fieldName = 'ID'): string {
...
export function validateLimit(limit: number | undefined, max = 100): number {
  const l = limit ?? 50;
