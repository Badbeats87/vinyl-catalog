 ...
 */
export async function sendSubmissionConfirmation(submission: SubmissionDetail): Promise<boolean> {
 ...
 */
export async function sendSubmissionStatusUpdate(
 ...
 */
export async function sendCounterOfferNotification(
  to: string,
 ...
 */
function formatSubmissionConfirmationText(submission: SubmissionDetail): string {
 ...
 */
function formatSubmissionConfirmationHtml(submission: SubmissionDetail): string {
 ...
 */
function formatStatusUpdateText(submission: SubmissionDetail, statusMessage: string): string {
  return `Dear Seller,
 ...
 */
function formatStatusUpdateHtml(submission: SubmissionDetail, statusMessage: string): string {
  return `<!DOCTYPE html>
<html>
<head>
  <meta charset="UTF-8">
 ...
 */
function formatCounterOfferText(
  submissionNumber: string,
  artist: string,
  title: string,
  newPrice: number,
 ...
 */
function formatCounterOfferHtml(
  submissionNumber: string,
  artist: string,
  title: string,
  newPrice: number,
 ...
 */
function formatOrderShippedText(orderNumber: string, trackingNumber: string): string {
  return `Dear Buyer,
 ...
 */
function formatOrderShippedHtml(orderNumber: string, trackingNumber: string): string {
  return `<!DOCTYPE html>
<html>
<head>
  <meta charset="UTF-8">
