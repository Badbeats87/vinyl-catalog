 ...
 */
export async function getPricingPolicyById(id) {
 ...
 */
export async function getActivePolicies(skip = 0, take = 50) {
 ...
 */
export async function getAllPolicies(skip = 0, take = 50) {
    return prisma.pricingPolicy.findMany({
        skip,
        take,
        orderBy: { createdAt: 'desc' },
 ...
 */
export async function getPoliciesByScope(scope, limit = 50) {
    return prisma.pricingPolicy.findMany({
        where: {
            scope,
            isActive: true,
 ...
 */
export async function getPolicyForGenre(genre) {
 ...
 */
export async function getPolicyForRelease(releaseId) {
 ...
 */
export async function updatePricingPolicy(id, input) {
 ...
 */
export async function getPolicyHistory(baseName) {
    return prisma.pricingPolicy.findMany({
        where: { name: baseName },
        orderBy: { version: 'asc' },
    });
 ...
 */
export async function getPoliciesRequiringManualReview() {
    return prisma.pricingPolicy.findMany({
        where: {
